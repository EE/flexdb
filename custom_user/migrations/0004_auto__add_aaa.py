...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Aaa'
        db.create_table(u'custom_user_aaa', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('us', self.gf('django.db.models.fields.IntegerField')()),
        ))
        db.send_create_signal(u'custom_user', ['Aaa'])


    def backwards(self, orm):
        # Deleting model 'Aaa'
        db.delete_table(u'custom_user_aaa')
    ...
    models = {
        ...
        u'custom_user.aaa': {
            'Meta': {'object_name': 'Aaa'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'us': ('django.db.models.fields.IntegerField', [], {})
        },
